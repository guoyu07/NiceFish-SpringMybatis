...
CREATE TABLE `user` (
  ...
  `UP_ID` varchar(128) DEFAULT NULL,
  `STATUS` int(11) DEFAULT '0' COMMENT '0未激活1已激活\n2已禁用',
  `TYPE` int(11) DEFAULT NULL COMMENT '1普通店员2技师3店长',
  `JOIN_TIME` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `LEAVE_TIME` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '离职时间',
  PRIMARY KEY (`USER_ID`)
